...
/*   Updated: 2019/10/28 19:31:19 by pganglof         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	c = 'D';
	printf("my ft_printf ret : %d\n", ft_printf("Hello %20s  a%30.40da cc%c  b%30p   p%-30.40u  blabla%X\n", "ca va ?", 420, c, str, 31464, -654));
	printf("printf ret : %d\n", printf("Hello %20s  a%30.40da cc%c  b%30p   p%-30.40u  blabla%X\n", "ca va ?", 420, c, str, 31464, -654));
	return (0);
}
